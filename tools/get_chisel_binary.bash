...
# have changed OUT_DIR to $PWD to get the binary in cwd and not install to /usr/local/bin
if [ "$DEBUG" == "1" ]; then
	set -x
fi
...
function install {
	...
	*) fail "unknown os: $(uname -s)";;
	...
	"darwin_amd64")
		...
		;;
	"darwin_arm64")
		URL="https://github.com/jpillora/chisel/releases/download/v1.9.1/chisel_1.9.1_darwin_arm64.gz"
		FTYPE=".gz"
		;;
	"linux_386")
		URL="https://github.com/jpillora/chisel/releases/download/v1.9.1/chisel_1.9.1_linux_386.gz"
		FTYPE=".gz"
		;;
	"linux_amd64")
		...
		;;
	"linux_arm64")
		URL="https://github.com/jpillora/chisel/releases/download/v1.9.1/chisel_1.9.1_linux_arm64.gz"
		FTYPE=".gz"
		;;
	"linux_arm")
		URL="https://github.com/jpillora/chisel/releases/download/v1.9.1/chisel_1.9.1_linux_armv5.gz"
		FTYPE=".gz"
		;;
